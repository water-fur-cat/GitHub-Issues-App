...
class ClosedIssueViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        GitHubClient.fetchIssues(state:"closed", completion: {(issues, error) in
            ...
            for issue in issues {
                self.issues_array.append(issue)
//                print("""
//                  ✔️ \(issue.title)
//                  Body: \(issue.body)
...
//                  """)
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return issues_array.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {

        let cell = tableView.dequeueReusableCell(withIdentifier: "Cell2", for: indexPath) as! IssueTableViewCell2

        // Configure the cell...
        cell.leftLabel2.text = issues_array[indexPath.row].title
        cell.rightLabel2.text = "@\(issues_array[indexPath.row].user.login)"
        
        // not show
        let imageObject = UIImage(named: "icon2.jpeg")
        cell.picture2.image = imageObject
        // Configure the cell...
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        detailsVC.data = issues_array[self.tableView.indexPathForSelectedRow!.row]
